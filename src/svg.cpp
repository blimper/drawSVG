...
void SVGParser::parseSVG( tinyxml2::XMLElement* xml, SVG* svg ) {
...
void SVGParser::parseElement( tinyxml2::XMLElement* xml, SVGElement* element ) {
...
void SVGParser::parsePoint( tinyxml2::XMLElement* xml, Point* point ) {
  point->position = Vector2D(xml->FloatAttribute( "x" ),
                             xml->FloatAttribute( "y" ));
}

void SVGParser::parseLine( tinyxml2::XMLElement* xml, Line* line ) {
...
void SVGParser::parsePolyline( tinyxml2::XMLElement* xml, Polyline* polyline ) {
...
void SVGParser::parseRect( tinyxml2::XMLElement* xml, Rect* rect ) {
...
void SVGParser::parsePolygon( tinyxml2::XMLElement* xml, Polygon* polygon ) {
...
void SVGParser::parseEllipse( tinyxml2::XMLElement* xml, Ellipse* ellipse ) {
...
void SVGParser::parseImage( tinyxml2::XMLElement* xml, Image* image ) {
...
void SVGParser::parseGroup( tinyxml2::XMLElement* xml, Group* group ) {
